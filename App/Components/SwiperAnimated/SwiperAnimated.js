...
import styles from './SwiperAnimated.style'
...
class Swiper extends Component {
  ...
  initializeCardStyle = () => {
    ...
    this.cardStyle = {
      ...
      width: cardWidth2 ? cardWidth2 : cardWidth,
      height: cardHeight2 ? cardHeight2 : cardHeight
    }
  ...
  swipeBack = cb => {
    // console.log('SwiperAnimated swipeBack')
...
Swiper.defaultProps = {
  ...
  overlayOpacityHorizontalThreshold: width / 20,
